	...
	<div class="col-md-7">
		...
		<table class="table table-hover table-stripped">
			...
			<thead>
				...
				<td>no</td><td>judul_buku</td></td><td>kategori</td><td>harga</td><td>stok</td><td></td><td></td>
			...
			<tbody>
				...
				<tr>
					...
					<td><?=$no?></td></td><td><?=$bk->judul_buku?></td><td><?=$bk->nama_kategori?></td><td><?=$bk->harga?></td><td><?=$bk->stok?></td>
