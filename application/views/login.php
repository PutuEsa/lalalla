				...
				<div class="auth-box ">
					<div class="left">
						<div class="content" style="width:300px;">
							<div class="header">
								<div class="logo text-center"><img style="width:30%; margin-bottom:30px;"src="<?= base_url()?>assets/img/boss.png" alt="Klorofil Logo"></div>
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">ChewyGums Bookstore</h1>
							<p>Kesuksesan diawali dari membaca</p>
						</div>
					</div>
